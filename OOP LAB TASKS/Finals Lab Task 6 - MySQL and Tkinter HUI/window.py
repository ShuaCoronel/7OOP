...
class Window:
    ...
    def settings(self):
        self.root.title("CRUD PYTHON MYSQL - BMWCars")  # Title of the window
    ...
    def create_widgets(self):
        ...
        self.buttonNew = tk.Button(frame1, text="Add Record", command=self.InsertData,
                                   width=24, height=2, background="#eba607", foreground="white")
        ...
        # self.buttonTot = tk.Button(frame1, text="Total Records", command=self.total_records,
        #                            width=24, height=2, background="#eba607", foreground="white")
        # self.buttonTot.place(x=10, y=350)

        self.buttonHighest = tk.Button(frame1, text="Show Highest Price", command=self.show_highest_price,
                                   width=24, height=2, background="#eba607", foreground="white")
    ...
    def show_highest_price(self):
        ...
        if row:
            model, price = row
            messagebox.showinfo("Highest Price",
                                f"Most expensive BMW:\n\nModel: {model}\nPrice: ${price:,.2f}")
    def fnInit(self):
